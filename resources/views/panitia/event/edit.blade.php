...
@section('title', 'Edit Event - MySMES')

@section('content')

<div class="mb-4">
    <h2 class="fw-bold">Edit Event Saya</h2>
    <p class="text-muted">Perbarui informasi event yang Anda kelola di bawah ini.</p>
</div>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4">
                ...
                @endif
                <form action="{{ route('panitia.event.update', $event->uuid) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        <div class="col-md-12">
                        ...
                        <div class="col-12 mt-4">
                            <div class="alert alert-warning border-0 rounded-4 small mb-0">
                                ...
                                Event ini sedang menunggu persetujuan Admin. Perubahan data mungkin akan memicu peninjauan ulang.
                            </div>
                        </div>
                        @endif
                    </div>
