...
@section('title', 'Tambah Event Umum - MySEMS')

@section('content')
<div class="mb-4">
    <h2 class="fw-bold">Tambah Event Umum Baru</h2>
    <p class="text-muted">Isi formulir di bawah untuk membuat event umum baru.</p>
</div>
                ...
                <form action="{{ route('admin.event.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="nama_event" class="form-control rounded-3 @error('nama_event') is-invalid @enderror" value="{{ old('nama_event') }}" placeholder="Contoh: Seminar Teknologi MySMES" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" name="slot_tim" class="form-control rounded-start-3 @error('slot_tim') is-invalid @enderror" value="{{ old('slot_tim') }}" placeholder="Contoh: 100" min="1" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="lokasi" class="form-control rounded-3 @error('lokasi') is-invalid @enderror" value="{{ old('lokasi') }}" placeholder="Contoh: Aula Serbaguna">
                        ...
                        <div class="col-12 mt-4">
                            <div class="alert alert-info border-0 rounded-4 small">
                                ...
                                Sebagai <strong>Admin</strong>, event umum ini akan otomatis aktif setelah disimpan.
                            </div>
                        </div>
                    </div>
                    <div class="mt-4">
