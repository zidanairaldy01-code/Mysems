...
@section('title', 'Tambah Event - MySEMS')

@section('content')
<div class="mb-4">
    <h2 class="fw-bold">Tambah Event Baru</h2>
    <p class="text-muted">Isi formulir di bawah untuk membuat event baru.</p>
</div>
                ...
                <form action="{{ route('admin.event.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_panitia" class="form-control rounded-3 @error('nama_panitia') is-invalid @enderror" value="{{ old('nama_panitia') }}" placeholder="Contoh: Panitia Pusat MySMES" required>
                        ...
                        <div class="col-12 mt-4">
                            <div class="alert alert-info border-0 rounded-4 small">
                                ...
                                Karena Anda adalah <strong>Admin</strong>, event ini akan otomatis berstatus <strong>Disetujui</strong>.
                            </div>
                        </div>
                    </div>
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary rounded-pill px-5 py-2 fw-bold">Simpan & Publikasikan</button>
