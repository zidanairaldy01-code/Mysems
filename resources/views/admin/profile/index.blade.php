...
@section('title', 'Profil Saya - MySEMS')
                ...
                <div class="d-flex align-items-center flex-column flex-sm-row">
                    ...
                    <div>
                        ...
                        <div class="d-flex gap-2">
                            <form action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" id="form-foto">
                                @csrf
                            ...
                            @if(Auth::user()->foto)
                            <form action="{{ route('admin.profile.delete-foto') }}" method="POST">
                                @csrf
